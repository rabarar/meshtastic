...
const file_meshtastic_admin_proto_rawDesc = "" +
	...
	"\x0f_set_power_mode\"\xe0\x01\n" +
	"\fSEN5X_config\x12,\n" +
	"\x0fset_temperature\x18\x01 \x01(\x02H\x00R\x0esetTemperature\x88\x01\x01\x12.\n" +
	"\x11set_one_shot_mode\x18\x02 \x01(\bH\x01R\x0esetOneShotMode\x88\x01\x01\x121\n" +
	"\x12start_fan_cleaning\x18\x03 \x01(\bH\x02R\x10startFanCleaning\x88\x01\x01B\x12\n" +
	"\x10_set_temperatureB\x14\n" +
	"\x12_set_one_shot_modeB\x15\n" +
	"\x13_start_fan_cleaning\"\x9b\x04\n" +
	"\fSEN6X_config\x12,\n" +
	"\x0fset_temperature\x18\x01 \x01(\x02H\x00R\x0esetTemperature\x88\x01\x01\x12.\n" +
	"\x11set_one_shot_mode\x18\x02 \x01(\bH\x01R\x0esetOneShotMode\x88\x01\x01\x121\n" +
	"\x12start_fan_cleaning\x18\x03 \x01(\bH\x02R\x10startFanCleaning\x88\x01\x01\x12\x1c\n" +
	"\aset_asc\x18\x04 \x01(\bH\x03R\x06setAsc\x88\x01\x01\x122\n" +
	"\x13set_target_co2_conc\x18\x05 \x01(\rH\x04R\x10setTargetCo2Conc\x88\x01\x01\x12&\n" +
	"\fset_altitude\x18\x06 \x01(\rH\x05R\vsetAltitude\x88\x01\x01\x125\n" +
	"\x14set_ambient_pressure\x18\a \x01(\rH\x06R\x12setAmbientPressure\x88\x01\x01\x12(\n" +
	"\rfactory_reset\x18\b \x01(\bH\aR\ffactoryReset\x88\x01\x01B\x12\n" +
	"\x10_set_temperatureB\x14\n" +
	"\x12_set_one_shot_modeB\x15\n" +
